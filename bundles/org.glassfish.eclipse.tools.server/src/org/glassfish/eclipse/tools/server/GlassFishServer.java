...
package org.glassfish.eclipse.tools.server;
...
import static org.glassfish.eclipse.tools.server.Messages.facetNotSupported;
import static org.glassfish.eclipse.tools.server.Messages.invalidPortNumbers;
import static org.glassfish.eclipse.tools.server.Messages.pathDoesNotExist;
import static org.glassfish.eclipse.tools.server.Messages.pathNotDirectory;
import static org.glassfish.eclipse.tools.server.Messages.pathNotValidDomain;
import static org.glassfish.eclipse.tools.server.Messages.pathNotWritable;
import static org.glassfish.eclipse.tools.server.Messages.serverWithSameDomainPathExisting;
...
import static org.glassfish.eclipse.tools.server.facets.internal.GlassFishDeploymentDescriptorFactory.getWebDeploymentDescriptor;
...
import static org.glassfish.eclipse.tools.server.utils.Utils.hasProjectFacet;
...
import org.glassfish.eclipse.tools.server.sdk.data.GlassFishAdminInterface;
import org.glassfish.eclipse.tools.server.sdk.server.parser.HttpData;
...
public final class GlassFishServer extends ServerDelegate implements IURLProvider {
	...
	public GlassFishServerBehaviour getServerBehaviourAdapter() {
		...
		if (serverBehavior == null) {
			serverBehavior = load(getServer(), GlassFishServerBehaviour.class);
		}
