...
import static org.glassfish.eclipse.tools.server.preferences.PreferenceConstants.ENABLE_LOG;
...
import org.glassfish.eclipse.tools.server.events.RuntimeLifecycleListener;
import org.glassfish.eclipse.tools.server.events.ServerLifecycleListener;
import org.osgi.framework.Bundle;
import org.osgi.framework.BundleContext;

/**
 * GlassFish Tools Server Plugin. This is used as the OSGi bundle activator, as well as the central
 * place to do logging.
 */
public class GlassFishServerPlugin extends AbstractUIPlugin {
    protected Map imageDescriptors = new HashMap();

    public static final String RUNTIME_TYPE = "glassfish.runtime"; //$NON-NLS-1$
...
//	}
    ...
    public static GlassFishServerPlugin getInstance() {
        return singleton;
    }
