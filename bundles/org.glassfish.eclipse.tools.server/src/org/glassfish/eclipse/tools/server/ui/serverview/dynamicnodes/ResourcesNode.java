...
import static org.glassfish.eclipse.tools.server.ui.serverview.dynamicnodes.NodeTypes.RESOURCES;
import static org.glassfish.eclipse.tools.server.utils.NodesUtils.getResourceData;
...
public class ResourcesNode extends TreeNode {
    ...
    public ResourcesNode(GlassFishServer server) {
