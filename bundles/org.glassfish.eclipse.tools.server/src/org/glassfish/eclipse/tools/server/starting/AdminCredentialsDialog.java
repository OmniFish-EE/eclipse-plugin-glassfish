/******************************************************************************
 * Copyright (c) 2020 XXXXX Foundation All rights reserved. This program and the accompanying
...
public class AdminCredentialsDialog extends TitleAreaDialog {
    ...
    private void createAdminNameComponent(Composite container) {
        ...
        adminNameText.setText(serverWorkingCopy.getAttribute(GlassFishServer.ATTR_ADMIN, "admin"));
    ...
    private void createPasswordComponent(Composite container) {
        ...
        passwordText.setText(serverWorkingCopy.getAttribute(GlassFishServer.ATTR_ADMINPASS, ""));
    ...
    protected void okPressed() {
        try {
            serverWorkingCopy.setAttribute(GlassFishServer.ATTR_ADMIN, adminNameText.getText());
            serverWorkingCopy.setAttribute(GlassFishServer.ATTR_ADMINPASS, passwordText.getText());
