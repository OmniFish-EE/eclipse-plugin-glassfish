...
import static org.glassfish.eclipse.tools.server.GlassFishServerPlugin.log;
...
import org.glassfish.eclipse.tools.server.utils.WtpUtil;
...
public class NewGlassFishServerWizardFragment extends WizardFragment {
	...
	private String[] instanceTypes = { GlassFishServer.DEFAULT_TYPE, GlassFishServer.DOCKER_TYPE, GlassFishServer.WSL_TYPE };
...
//				IRuntimeWorkingCopy c2 = getServerRuntime();
		...
		instanceTypeCombo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (GlassFishServer.DOCKER_TYPE.equals(instanceTypes[instanceTypeCombo.getSelectionIndex()])) {
